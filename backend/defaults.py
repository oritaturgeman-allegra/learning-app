...
APP_CHANGELOG: List[Dict[str, str]] = [
    {
        "version": "3.0.4",
        "text": "תיקון: לחיצה על סבב חדש מנקה גם את הסימון הירוק בבחירת שיעור ✅",
    },
    {
        "version": "3.0.3",
    ...
    {
        "version": "3.0.1",
        "text": "שיפור ניווט: כרטיסי השיעורים בנושא נראים אחרת מכרטיס הנושא 💜",
    },
    {
        "version": "3.0.0",
        "text": "הגרסה החדשה כאן! עיצוב מחודש, טעינה מהירה יותר, ואפליקציה אחת ויחידה 🚀",
    },
    {
        "version": "2.18.0",
    ...
    {
        "version": "2.16.0",
        "text": "הוספנו צלילים, קונפטי ואנימציות חגיגה! כל 5 כוכבים תקבלי הפתעה 🎉",
    },
    {
        "version": "2.15.0",
